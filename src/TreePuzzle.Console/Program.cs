...
public class CLI
{
    ...
    {
        string original = Constants.DEFAULT_INPUT;
        ...
        while (isContinued)
        {
            ...
            useOriginal = Convert.ToString(Console.ReadLine()) == "y" ? true : false;
            ...
            Console.WriteLine("Do you want to process another set (y/n)?");
            isContinued = Convert.ToString(Console.ReadLine()) == "y" ? true : false;
        }
